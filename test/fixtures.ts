...
export const tradeFactoryFixture = async (
  ...
  const tradeFactoryFactory = (await ethers.getContractFactory(
    'solidity/contracts/TradeFactory/TradeFactory.sol:TradeFactory'
  )) as TradeFactory__factory;
...
export const uniswapV2SwapperFixture = async (
  ...
  const uniswapV2AsyncSwapperFactory = await ethers.getContractFactory(
    'solidity/contracts/swappers/async/UniswapV2Swapper.sol:UniswapV2Swapper'
  );
  const uniswapV2SyncSwapperFactory = await ethers.getContractFactory('solidity/contracts/swappers/sync/UniswapV2Swapper.sol:UniswapV2Swapper');
